...
public class publicVariables {
    ...
    //VRF DATAS
    public static ObservableList<String> ciudadesVRF = FXCollections.observableArrayList();
    public static ObservableList<String> empresasVRF = FXCollections.observableArrayList();
    public static ObservableList<String> vlansVRF = FXCollections.observableArrayList();
    ...
    public static Boolean transActive = false;
