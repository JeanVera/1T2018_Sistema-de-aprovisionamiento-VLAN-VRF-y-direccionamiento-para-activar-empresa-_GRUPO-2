...
public class CreatedVLANonPEFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        publicVariables.altura=311;
        publicVariables.ancho=411;
        
        System.out.println("I AM HERE VLAN");
...
//        nombre_ciudad = publicVariables.city;
//        txtCiudad.setText(nombre_ciudad);
    }

    @FXML
    public void btnCerrar() throws IOException {
    ...
    public void verifyCreacionOfVLAN() throws IOException, SQLException {
        ...
        if (nombre_empresa.isEmpty() || nombre_ciudad.isEmpty()
            ...
            publicVariables.num_vlan_fin=Integer.parseInt(num_vlan);
            publicVariables.city=nombre_ciudad;
            //            
            extraerData("clientes");
            //
    ...
    /**
     * SI EL VALOR DE LA VLAN ESTA DENTRO DE LOS RANGOS PERMITIDOS SI EL VALOR
     * DE LA VLAN ESTA DENTRO DE LOS RANGOS PERMITIDOS
     */
    ...
    private void extraerData(String ciudad) throws SQLException {
        ...
        String tabla = ciudad.toLowerCase() + "_vlans";

        //SE FILTRAN LOS DATOS CORRESPONDIENTE A LA CIUDAD EN PARTICULAR
        conexion.buscarDato("numero_vlan,nombre_empresa,ciudad", tabla, "", "", false);
    ...
    /**
     * METODO QUE VERIFICA SI EXISTEN VLAN DISPONIBLES EN LA CIUDAD PARA SER
     * ASIGNADAS
     *
     * @return
     */
    private boolean verificaDisponibilidadDeVLAN() {
         ...
         */
        if (conexion.getTotalDatos() < 4096) {
            res = true;
        }
    ...
    /**
     * METODO QUE VERIFICA SI LA EMPRESA EXISTE EN LA BASE DE DATOS, EL HECHO DE
     * EXISTIR EN LA BASE DE DATOS ES INDICIO PARA CONCLUIR DE QUE LA EMPRESA
     * POSEE YA VLAN ASIGNADA, RETORNA TRUE SI ESE ES EL CASO
     *
     * @return
     */
